...
func (_m *Repository) Create(ctx context.Context, p entity.Product) error {
	ret := _m.Called(ctx, p)
...
func (_m *Repository) Get(ctx context.Context, id uuid.UUID) (entity.Product, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Repository) GetAll(ctx context.Context) ([]entity.Product, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) Update(ctx context.Context, p *entity.Product) error {
	ret := _m.Called(ctx, p)
