...
func (_m *UseCase) Get(ctx context.Context, id uuid.UUID) (entity.Product, error) {
	ret := _m.Called(ctx, id)
...
func (_m *UseCase) Index(ctx context.Context) ([]entity.Product, error) {
	ret := _m.Called(ctx)
...
func (_m *UseCase) Store(ctx context.Context, name string, varejoPrice float64, atacadoPrice float64, atacadoAmount int) (entity.Product, error) {
	ret := _m.Called(ctx, name, varejoPrice, atacadoPrice, atacadoAmount)

	var r0 entity.Product
	if rf, ok := ret.Get(0).(func(context.Context, string, float64, float64, int) entity.Product); ok {
...
func (_m *UseCase) Update(ctx context.Context, p *entity.Product) error {
	ret := _m.Called(ctx, p)
