...
func (_m *Writer) Create(ctx context.Context, p entity.Popsicle) error {
	ret := _m.Called(ctx, p)
...
func (_m *Writer) Delete(ctx context.Context, id entity.ID) error {
...
func (_m *Writer) Update(ctx context.Context, p *entity.Popsicle) error {
	ret := _m.Called(ctx, p)
