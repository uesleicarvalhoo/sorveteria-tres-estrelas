...
func (_m *Repository) Create(ctx context.Context, u entity.User) error {
	ret := _m.Called(ctx, u)
...
func (_m *Repository) Get(ctx context.Context, id entity.ID) (entity.User, error) {
...
func (_m *Repository) GetByEmail(ctx context.Context, email string) (entity.User, error) {
