<template>
  <nav v-show="isNavBarVisible" class="top-0 left-0 right-0 fixed flex bg-white h-14 border-b border-gray-100 z-30 w-screen
    ...
    <div
      ...
      <div class="
        ...
        <nav-bar-item @click="logoutClick" class="right-0">
