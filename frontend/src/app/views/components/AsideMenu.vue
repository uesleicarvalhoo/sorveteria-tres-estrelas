<template>
  <aside v-show="!isFullScreen" class="w-60 fixed top-0 z-40 h-screen bg-gray-800 transition-position lg:left-0 overflow-y-scroll
    ...
    <div class="flex flex-row w-full bg-gray-900 text-white flex-1 h-14 items-center">
      ...
      <div class="flex-1 px-3">
        <span>Sorveteria três estrelas</span>
      </div>
    </div>
    <div>
