...
func (_m *UseCase) Create(ctx context.Context, name string, email string, password string, permissions ...user.Permission) (user.User, error) {
	...
	var r0 user.User
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, ...user.Permission) user.User); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, string, string, ...user.Permission) error); ok {
