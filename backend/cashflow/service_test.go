		...
		},
		{
			...
			expectedCashFlow: cashflow.CashFlow{
				...
				Details: []cashflow.Detail{
					...
					{Description: "payment 3", Value: 2, Type: cashflow.PaymentBalance, Date: makeDate(2020, 1, 7)},
					{Description: "payment 2", Value: 3, Type: cashflow.PaymentBalance, Date: makeDate(2020, 1, 5)},
					{Description: "sale 1\n", Value: 5, Type: cashflow.SaleBalance, Date: makeDate(2020, 1, 2)},
					{Description: "payment 1", Value: 5, Type: cashflow.PaymentBalance, Date: makeDate(2020, 1, 1)},
				},
			},
			expectedError: nil,
		},
