...
import (
	...
	payment "github.com/uesleicarvalhoo/sorveteria-tres-estrelas/backend/payment"
...
func (_m *UseCase) GetAll(ctx context.Context) ([]payment.Payment, error) {
	ret := _m.Called(ctx)
...
func (_m *UseCase) GetByPeriod(ctx context.Context, startAt time.Time, endAt time.Time) ([]payment.Payment, error) {
...
func (_m *UseCase) RegisterPayment(ctx context.Context, value float32, desc string) (payment.Payment, error) {
	ret := _m.Called(ctx, value, desc)

	var r0 payment.Payment
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, float32, string) (payment.Payment, error)); ok {
		return rf(ctx, value, desc)
	}
	if rf, ok := ret.Get(0).(func(context.Context, float32, string) payment.Payment); ok {
...
func (_m *UseCase) UpdatePayment(ctx context.Context, id uuid.UUID, value float32, desc string) (payment.Payment, error) {
	ret := _m.Called(ctx, id, value, desc)

	var r0 payment.Payment
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, float32, string) (payment.Payment, error)); ok {
		return rf(ctx, id, value, desc)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, float32, string) payment.Payment); ok {
