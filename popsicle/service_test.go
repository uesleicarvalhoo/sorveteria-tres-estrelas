...
import (
	...
	"github.com/uesleicarvalhoo/sorveteria-tres-estrelas/popsicle/mocks"
)
...
func TestServiceCreate(t *testing.T) {
	...
	t.Run("when all fields are ok", func(t *testing.T) {
		...
		// Action
		pop, err := sut.Create(context.Background(), flavor, price)
	...
	for _, tc := range testErrors {
		...
		t.Run(tc.about, func(t *testing.T) {
			...
			// Action
			p, err := sut.Create(context.Background(), tc.flavor, tc.price)

			// Assert
			assert.Equal(t, popsicle.Popsicle{}, p)
...
func TestServiceGetAll(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.describe, func(t *testing.T) {
			...
			// Action
			found, err := service.GetAll(context.Background())
...
func TestServiceUpdate(t *testing.T) {
	...
	t.Run("when update return an errror", func(t *testing.T) {
		...
		// Arrange
		p := popsicle.Popsicle{ID: uuid.New(), Flavor: "amendoin", Price: 1.25}
